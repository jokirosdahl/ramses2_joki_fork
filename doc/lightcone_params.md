...
| `cone_z_max`          | `real`       | 1.0           | Maximum redshift to consider for the light cone output.                                       |
| `cone_z_min`          | `real`       | 0.0           | Minimum redshift to consider for the light cone output.                                       |
| `cone_observer`       | `real` array | 0.,0.,0.   | Position of the observer in the simulation box (x,y,z coordinates in box units).              |
