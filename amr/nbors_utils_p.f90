module nbors_utils_p
contains
!###############################################################
!###############################################################
!###############################################################
!###############################################################
subroutine get_threetondim_nbor_parent_cell_p(s,hash_key,hash_dict,grid_nbor,ind_nbor,flush_cache,fetch_cache)
...
end subroutine get_threetondim_nbor_parent_cell_p
!###############################################################
!###############################################################
!###############################################################
!###############################################################
subroutine get_twondim_nbor_parent_cell_p(s,hash_key,hash_dict,grid_nbor,ind_nbor,flush_cache,fetch_cache)
...
end subroutine get_twondim_nbor_parent_cell_p
!###############################################################
!###############################################################
!###############################################################
!###############################################################
...
!###############################################################
!###############################################################
subroutine lock_cache_p(s,child)
  use amr_commons, only: oct
  use ramses_commons, only: ramses_t
  implicit none
  type(ramses_t)::s
...
subroutine get_grid_p(s,hash_key,hash_dict,child,flush_cache,fetch_cache,lock)
  ...
  integer::i,ind,idim,ivar,iskip,ichild,ilevel,info,grid_cpu,ntile_response,icounter,child_grid
