...
function worker_init(mdl) result(pst)
  ...
  call mdl_add_service(pst%s%mdl,MDL_STAR_CR_FEEDBACK,       pst,C_FUNLOC(r_star_cr_feedback),1,0,"star_cr_feedback")
  ...
  call mdl_add_service(pst%s%mdl,MDL_CR_NEQ_UPDATES,         pst,C_FUNLOC(r_cr_neq_updates),1,0,"cr_neq_updates")
#ifdef _CUDA
