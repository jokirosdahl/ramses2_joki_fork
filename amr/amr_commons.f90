module amr_commons
  ...
  type run_t
     ...
     real(kind=8)::grain_size=0.0d0   ! Dust particle size parameter (dimensionless)
     real(kind=8)::grain_charge=0.0d0  ! Dust particle charge-to-mass ratio (dimensionless)
