...
subroutine m_read_params(pst)
  ...
  integer :: dust_force_interpolation_scheme=1 ! dust force interpolation schemes (1: CIC, 2: TSC, 3: PCS, 4: CIC with num-diff stochastic kick, 5: TSC with num-diff stochastic kick)
