module cooling_module
  ...
  ! Size and boundaries of the cooling table
  ...
  real(kind=8),parameter::dumfac_rec_theuns=0.75D0
...
!!$        endif
  ...
  !=======================================================================
  function J0simple(aexp,J0in,J0min,zreioniz)
    !=======================================================================
    ! Le J0 dans le cas theuns
    !=======================================================================
    real(kind=8) :: J0simple,J0in,J0min,aexp,zreioniz
  ...
  subroutine cmp_table(nH_min,nH_max,T2_min,T2_max,nbin_n,nbin_T,aexp)
    ...
    allocate(table%n_spec(nbin_n,nbin_T,1:6))
    do i_n=1,nbin_n
  ...
  subroutine set_rates(t_rad_spec,h_rad_spec,aexp)
    ...
    if (theuns) then
       J0=J0simple(aexp,J0in,J0min,zreioniz)
  ...
  !=======================================================================
  function taux_rad_theuns(ispec,J0,alpha)
    !=======================================================================
    implicit none
    integer :: ispec
    real(kind=8) :: J0,alpha,taux_rad_theuns
    taux_rad_theuns=0
  ...
  !=======================================================================
  function heat_rad_theuns(ispec,J0,alpha)
    !=======================================================================
    implicit none
    integer :: ispec
    real(kind=8) :: J0,alpha,heat_rad_theuns
    heat_rad_theuns=0
