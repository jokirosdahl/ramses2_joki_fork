...
module photoionization_UVB_module
  ...
  real(KIND=8):: HM12_UVB_magnesium(N_UVB_POINTS,12,2)
  real(KIND=8):: HM12_UVB_silicon(N_UVB_POINTS,14,2)
  real(KIND=8):: HM12_UVB_sulfur(N_UVB_POINTS,16,2)
  real(KIND=8):: HM12_UVB_iron(N_UVB_POINTS,26,2)

  ! Array that holds the UVB for each ion at a given redshift
  real(KIND=8):: HM12_UVB_z(27,27,2)
...
subroutine update_UVB(redshift)
    ...
    real(KIND=8):: scale_low, scale_high
