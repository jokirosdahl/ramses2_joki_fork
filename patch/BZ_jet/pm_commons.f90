...
#ifdef BZ_sink
     real(dp),allocatable,dimension(:)     ::mBH      ! Black Hole mass
     real(dp),allocatable,dimension(:)     ::mD       ! Sub-grid Disc mass
     real(dp),allocatable,dimension(:,:)   ::jD       ! Sub-grid Disc angular momentum
#endif
