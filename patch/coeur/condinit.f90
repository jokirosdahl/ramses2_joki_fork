...
subroutine condinit_2(r,g,x,u,dx,nn)
  ...
  integer::ivar,i,nx_loc
  real(dp),dimension(1:nvector,1:nvar),save::q   ! Primitive variables
  real(dp)::phi,r2,rx,ry,rz,d_trunc,d,p,om,vx,vy,vz,r_trunc,r2_trunc,rr,c2
  real(dp)::omega_phys,omega_code,AU,Msol,pi,M,alpha,sigma,r_min,r2_min,omega_const,r_vortex,invr2_vortex
  real(dp)::scale_nH,scale_T2,scale_l,scale_d,scale_t,scale_v,scale_m,scale_p
