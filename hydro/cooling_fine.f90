...
!###########################################################
!###########################################################
recursive subroutine r_cooling_fine(pst,cpu_range,input_size,output_size,ilevel)
  ...
  if(next_range>0)then
     call mdl_send_request(pst%s%mdl,MDL_COOLING_FINE,next_cpu,next_range,input_size,output_size,ilevel)
     call r_cooling_fine(pst,next_range,input_size,output_size,ilevel)
  else
