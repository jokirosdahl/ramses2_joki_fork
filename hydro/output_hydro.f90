...
!###################################################
!###################################################
recursive subroutine r_output_hydro(pst,cpu_range,input_size,output_size,input_array)
  ...
  if(next_range>0)then
     call mdl_send_request(pst%s%mdl,MDL_OUTPUT_HYDRO,next_cpu,next_range,input_size,output_size,input_array)
     call r_output_hydro(pst,next_range,input_size,output_size,input_array)
  else
